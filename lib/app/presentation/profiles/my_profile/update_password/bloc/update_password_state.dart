part of 'update_password_bloc.dart';
 ...
 class UpdatePasswordState extends Equatable {
   ...
   const UpdatePasswordState({
     ...
     this.currentPasswordInputValidator = const CurrentPasswordInputValidator.pure(),
      this.passwordInputValidator = const PasswordInputValidator.pure(),
     this.confirmPasswordInputValidator = const ConfirmPasswordInputValidator.pure(),
   ...
   UpdatePasswordState copyWith({
     ...
     bool? isValid,
       ...
       UpdatePasswordState(
         ...
         currentPasswordInputValidator: currentPasswordInputValidator ?? this.currentPasswordInputValidator,
         passwordInputValidator:
         passwordInputValidator ?? this.passwordInputValidator,
         confirmPasswordInputValidator: confirmPasswordInputValidator ?? this.confirmPasswordInputValidator,
