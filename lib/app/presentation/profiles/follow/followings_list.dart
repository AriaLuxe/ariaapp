                              ...
                              itemBuilder: (context, index) {
                                ...
                                return ListTile(
                                  title: InkWell(
                                      ...
                                      child: Text(
                                          '${following.nameUser} ${following.lastName}',
                                  ...
                                  leading: InkWell(
                                    ...
                                    child: CircleAvatar(
                                      backgroundImage: NetworkImage(
                                          '${BaseUrlConfig.baseUrlImage}${following.imgProfile}'),
                                    ),
                                  ),
                                  onTap: () {},
                                );
