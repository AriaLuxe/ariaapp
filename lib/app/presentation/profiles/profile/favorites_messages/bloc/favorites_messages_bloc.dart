...
class FavoritesMessagesBloc extends Bloc<FavoritesMessagesEvent, FavoritesMessagesState> {
  ...
  Future<void> _onFavoriteMessageFetched(
    ...
    emit(state.copyWith(favoritesMessagesStatus: FavoritesMessagesStatus.loading));
    try {
      ...
      final favoritesMessageProcess = _processFavoritesMessages(favoritesMessages,userId);
      ...
      print(e);
      emit(state.copyWith(favoritesMessagesStatus: FavoritesMessagesStatus.error));
    }
  }
  ...
  List<FavoritesMessageWidget> _processFavoritesMessages(List<Message> messages, int userId) {
