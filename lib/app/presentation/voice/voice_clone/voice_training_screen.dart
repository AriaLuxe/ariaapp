                ...
                child: Column(
                  ...
                  children: [
                   Padding(
                    ...
                    const QuestionResponse(question: '¿Cúal es tu nombre y como te gusta que te llamen?', namePath: 'primera_pregunta',),
                    const SizedBox(
                        height: 10
                    ),
                    const QuestionResponse(question: '¿Cúal es tu comida favorita y por qué?(Sé breve, por favor)', namePath: 'segunda_pregunta',),
                    const SizedBox(
                        height: 10
                    ),
                    const QuestionResponse(question: '¿Cúal es tu canción favorita  y por qué?(Sé breve, por favor)', namePath: 'tercera_pregunta',),
                    const SizedBox(
                        height: 10
                    ),
                    const QuestionResponse(question: '¿Puedes contarme un chiste o una experiencia que te hizo reír mucho?', namePath: 'cuarta_pregunta',),
                    const SizedBox(
                      height: 10
                    ),
                    const QuestionResponse(question: '¿Cómo te sentirías si ganaras un premio sorpresa en este momento?', namePath: 'quinta_pregunta',),
                    const SizedBox(
                        height: 10
                    ),
                    Align(
