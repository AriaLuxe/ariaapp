...
class VoiceBloc extends Bloc<VoiceEvent, VoiceState> {
  ...
  Future<void> _onShowPlayer(ShowPlayer event, Emitter<VoiceState> emit) async {
    try {
  ...
  Future<void> _onDeletePath(
      DeleteAudio event, Emitter<VoiceState> emit) async {
    try {
  ...
  Future<void> _onUpdateStability(
  ...
  Future<void> _onUpdateSimilarity(
    UpdateSimilarity event,
    Emitter<VoiceState> emit,
  ) async {
    emit(state.copyWith(
