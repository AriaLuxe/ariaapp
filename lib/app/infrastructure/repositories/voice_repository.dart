...
class VoiceRepository extends VoiceInterface{
  ...
  @override
  Future<void> cloneVoice(List<String> audioPaths, String imgPath, String name, String description) {
  ...
  Future<String> editSettingsVoiceClone(int userId, double stability, double similarity) async {
    return await voiceCloneDataProvider.editSettingsVoiceClone(userId, stability, similarity);
  }

  @override
  Future<String> editVoiceClone(int userId, String name, String description) async {
    return await voiceCloneDataProvider.editVoiceClone(userId, name, description);
  }
